...
func (c *productServiceClient) GetProductByID(ctx context.Context, in *Product, opts ...grpc.CallOption) (*Product, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Product)
...
func (c *productServiceClient) DeleteProduct(ctx context.Context, in *Product, opts ...grpc.CallOption) (*ProductResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProductResponse)
...
func (UnimplementedProductServiceServer) GetProductByID(context.Context, *Product) (*Product, error) {
...
func (UnimplementedProductServiceServer) DeleteProduct(context.Context, *Product) (*ProductResponse, error) {
...
func _ProductService_GetProductByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetProductByID(ctx, req.(*Product))
	}
	return interceptor(ctx, in, info, handler)
}
